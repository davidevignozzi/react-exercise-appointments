const data = [
    {
      ...
      stato: "No pain no Gain XOXO Gym Muscles Power",
      img:
    ...
    },
    {
      ...
      stato: "Music is for the soul what gymnastics is for the body.",
      img:
    ...
    },
    {
      id: 3,
      nome: "Mike Russel",
      stato: "Don't let anyone tell you that you are not capable",
      img:
    ...
    },
    {
      ...
      stato:
        "Photography is passion and love, it is the passing emotion, which arrives and immediately flies away.",
      img:
    ...
    },
    {
      ...
      stato: "I wouldn't eat a burger even if they paid me $ 40,000",
      img:
